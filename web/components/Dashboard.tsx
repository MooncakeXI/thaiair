    ...
    <main className="app-shell">
      ...
      <section className="hero" id="top">
        <div>
          ...
          <h1><span>วันนี้ถึงพรุ่งนี้</span><span>อากาศเป็นไง?</span></h1>
        </div>
        <p>ดู PM2.5 อุณหภูมิ และโอกาสฝน พร้อมพยากรณ์ล่วงหน้าทุก 3 ชั่วโมง รอบกรุงเทพฯ 25 กิโลเมตร</p>
      </section>
      ...
      <section className="workspace" aria-busy={!data && !error}>
        <div className="map-panel">
          ...
          <div className="map-hint">คลิกจุดสถานีเพื่อดูข้อมูล</div>
        ...
        <aside className="detail-panel">
          ...
          <details className="station-browser">
            <summary><span>ค้นหา/เลือกสถานีอื่น</span><strong>{data?.stations.length ?? 0} สถานี</strong></summary>
            <div className="station-browser-content">
      ...
      <footer>
        ...
        <span>ข้อมูลจาก OpenAQ และ Open-Meteo · แผนที่ © OpenStreetMap contributors</span>
      </footer>
    </main>
  );
}
